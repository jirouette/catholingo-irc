...
The **Admin** service allows users to use admin centered actions. It is highly unsecure and it currently does not recognize admin users. You shouldn't use it. If you still want to use it, it is recommended to use the `docker-compose` architecture.
